...
public class SortTypeAdapter extends RecyclerView.Adapter<SortTypeAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(SortTypeUI data) {
            ...
            final int sortResId = getSortTypeStringResource(data.getSortType());
            binding.text.setText(sortResId);
            binding.selected.setVisibility(data.isSelected() ? View.VISIBLE : View.GONE);
        }


        private int getSortTypeStringResource(SortType sortType) {
            switch (sortType) {
                case BY_NAME:
                ...
                default:
                    throw new IllegalArgumentException("Not supported SortType: " + sortType);
            }
        }
    }
}
